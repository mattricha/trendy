...
<div class="artistPage" ng-app="artistApp" ng-controller="artistController">
            ...
            <div class="artist-details-panel row">
                ...
                <div class="col-sm-12 col-md-8">
                    ...
                    <div class="artist-dateJoined">
                        <small>Member since:</small>&nbsp;&nbsp; {{date('d-m-Y', strtotime($artist->dateJoined))}}
                    </div>
                    @if(Auth::check())
                    <br>
                    <div ng-show="!boolInFollow" class="artist-follow">
                        <button class="btn btn-default btn-md" ng-click="addToFollow({{$artist->id}})"><i class="glyphicon glyphicon-link"></i>&nbsp;Follow</button>
                    </div>
                    <div ng-show="boolInFollow" class="artist-follow">
                        <button class="btn btn-default btn-md" ng-click="removeFromFollow({{$artist->id}})"><i class="glyphicon glyphicon-link"></i>&nbsp;Unfollow</button>
                    </div>
                    @endif
                </div>
            </div>
